...
3. Runtime performance is not sufficiently optimized. The code still takes about half a second per frame on a GTX 1080 GPU. I have identified a few code sections that can be made significantly faster.
