...
namespace ITMLib
{
	...
	class VisualizationEngine_CUDA : public RenderingEngineBase < TVoxel, TIndex >
	{
	private:
	...
	public:
		...
		void CreatePointCloud(VoxelVolume<TVoxel,TIndex> *scene, const View *view, CameraTrackingState *trackingState, RenderState *renderState) const;
	...
	class VisualizationEngine_CUDA<TVoxel, VoxelBlockHash> : public RenderingEngineBase < TVoxel, VoxelBlockHash >
	{
	private:
		uint* noTotalPoints_device;
	...
	public:
		...
		void CreatePointCloud(VoxelVolume<TVoxel,VoxelBlockHash> *scene, const View *view, CameraTrackingState *trackingState, RenderState *renderState) const;
