...
template <typename TSurfel>
void DenseSurfelMapper<TSurfel>::ProcessFrame(const View *view, const CameraTrackingState *trackingState, SurfelScene<TSurfel> *scene, SurfelRenderState *liveRenderState) const
{
