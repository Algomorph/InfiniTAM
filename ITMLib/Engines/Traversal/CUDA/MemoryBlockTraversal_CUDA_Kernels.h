...
__global__ void memoryBlockTraversalWithItemIndex_device(TData* data, size_t element_count, TFunctor* functor_device){
	int i_item = threadIdx.x + blockIdx.x * blockDim.x;
