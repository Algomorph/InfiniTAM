...
namespace {
// CUDA global kernels
template<ITMLib::JobCountPolicy TJobCountPolicy, ITMLib::TraversalMethod TTraversalMethod>
struct RawTraversal_CUDA_globals;

template<>
struct RawTraversal_CUDA_globals<ITMLib::JobCountPolicy::EXACT, ITMLib::TraversalMethod::CONTIGUOUS> {
...
template<>
struct RawTraversal_CUDA_globals<ITMLib::JobCountPolicy::EXACT, ITMLib::TraversalMethod::INDEX_SAMPLE> {
	template<typename TApplyFunction>
...
template<>
struct RawTraversal_CUDA_globals<ITMLib::JobCountPolicy::PADDED, ITMLib::TraversalMethod::CONTIGUOUS> {
	template<typename TData, typename TFunctor>
...
template<>
struct RawTraversal_CUDA_globals<ITMLib::JobCountPolicy::PADDED, ITMLib::TraversalMethod::INDEX_SAMPLE> {
	template<typename TData, typename TFunctor>
