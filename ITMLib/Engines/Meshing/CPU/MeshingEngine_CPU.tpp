...
#ifdef WITH_OPENMP
#pragma omp parallel for default(none) shared(hash_table, voxels, utilized_block_indices, triangle_count, triangle_table, triangles_device, utilized_block_count, voxel_size)
#endif
