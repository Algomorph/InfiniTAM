...
public:
	...
	static TOutput ReduceUtilized(Vector3i& position, const VoxelVolume<TVoxel, VoxelBlockHash>* volume,
		...
		return ReduceUtilized_OpenMP_Generic<TReduceBlockLevelStaticFunctor, TReduceResultLevelStaticFunctor, TOutput>(
				position, volume,
...
private:
	...
	static TOutput ReduceUtilized_OpenMP_Generic(Vector3i& position, const VoxelVolume<TVoxel, VoxelBlockHash>* volume,
...
#pragma omp parallel for
	...
	template<typename TReduceBlockLevelStaticFunctor, typename TReduceResultLevelStaticFunctor, typename TOutput, typename TRetrieveFunction>
	static TOutput ReduceUtilized_ThreadPool_Generic(Vector3i& position, const VoxelVolume<TVoxel, VoxelBlockHash>* volume,
	                                                 TRetrieveFunction&& retrieve_function,
	                                                 ReductionResult<TOutput, VoxelBlockHash> ignored_value = {TOutput(0), 0u, 0}) {
