...
extern template class VolumeReductionEngine<TSDFVoxel, PlainVoxelArray, MEMORYDEVICE_CPU>;
extern template class VolumeReductionEngine<WarpVoxel, PlainVoxelArray, MEMORYDEVICE_CPU>;
