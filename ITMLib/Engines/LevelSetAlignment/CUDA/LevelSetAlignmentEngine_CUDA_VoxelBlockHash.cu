...
#include "../../Traversal/CUDA/ThreeVolumeTraversal_CUDA_VoxelBlockHash.h"
...
namespace ITMLib {
template
class LevelSetAlignmentEngine<TSDFVoxel, WarpVoxel, VoxelBlockHash, MEMORYDEVICE_CUDA, OPTIMIZED>;
template
class LevelSetAlignmentEngine<TSDFVoxel, WarpVoxel, VoxelBlockHash, MEMORYDEVICE_CUDA, DIAGNOSTIC>;
} // namespace ITMLib