...
namespace ITMLib
{
  ...
  private:
     ...
     */
    virtual void AddNewSurfels(SurfelScene<TSurfel> *scene, const View *view, const CameraTrackingState *trackingState) const = 0;
     ...
     */
    virtual void FindCorrespondingSurfels(const SurfelScene<TSurfel> *scene, const View *view, const CameraTrackingState *trackingState,
     ...
     * \param trackingState   The current tracking state.
     */
    virtual void FuseMatchedPoints(SurfelScene<TSurfel> *scene, const View *view, const CameraTrackingState *trackingState) const = 0;
     ...
     */
    virtual void PreprocessDepthMap(const View *view, const SurfelVolumeParameters& sceneParams) const = 0;
  ...
  public:
     ...
     * \param renderState   The render state corresponding to the camera from which the scene is being viewed.
     */
    void IntegrateIntoScene(SurfelScene<TSurfel> *scene, const View *view, const CameraTrackingState *trackingState, const SurfelRenderState *renderState);
