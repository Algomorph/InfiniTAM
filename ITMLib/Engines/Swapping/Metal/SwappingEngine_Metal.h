...
namespace ITMLib
{
    ...
    public:
        ...
        void IntegrateGlobalIntoLocal(ITMScene<TVoxel,TIndex> *scene, View *view) {}
        void SaveToGlobalMemory(ITMScene<TVoxel,TIndex> *scene, View *view) {}
    };
    ...
    {
    protected:
        int DownloadFromGlobalMemory(ITMScene<TVoxel,ITMVoxelBlockHash> *scene, View *view);
    ...
    public:
        ...
        void IntegrateGlobalIntoLocal(ITMScene<TVoxel,ITMVoxelBlockHash> *scene, View *view);
