...
#include "RaycastingEngine_Specialized.h"
...
void RaycastingEngine_Specialized<TVoxel, PlainVoxelArray, TMemoryDeviceType>::CreateExpectedDepths(
...
template<class TVoxel, MemoryDeviceType TMemoryDeviceType>
void RaycastingEngine_Specialized<TVoxel, VoxelBlockHash, TMemoryDeviceType>::FindVisibleBlocks(
...
template<class TVoxel, MemoryDeviceType TMemoryDeviceType>
int RaycastingEngine_Specialized<TVoxel, VoxelBlockHash, TMemoryDeviceType>::CountVisibleBlocks(
...
template<class TVoxel, MemoryDeviceType TMemoryDeviceType>
void RaycastingEngine_Specialized<TVoxel, VoxelBlockHash, TMemoryDeviceType>::CreateExpectedDepths(
	...
	ORUtils::MemoryBlock<RaycastingBlock> rendering_blocks(ITMLib::MAX_RENDERING_BLOCKS, TMemoryDeviceType);
	...
	Regular2DSubGridArrayTraversal<TMemoryDeviceType>::template Traverse<rendering_block_size_x, rendering_block_size_y>(
			...
			CPU_AND_GPU_NONCAPTURE_LAMBDA()(const RaycastingBlock& block, int& start_x, int& end_x, int& start_y, int& end_y) {
