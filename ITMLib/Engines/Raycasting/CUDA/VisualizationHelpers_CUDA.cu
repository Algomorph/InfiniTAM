...
__global__ void ITMLib::checkProjectAndSplitBlocks_device(const HashEntry* hash_entries, int noHashEntries,
                                                          ...
                                                          RaycastingBlock* renderingBlocks,
                                                          uint* noTotalBlocks) {
...
__global__ void ITMLib::fillBlocks_device(uint block_count, const RaycastingBlock* rendering_blocks,
	...
	const RaycastingBlock& b(rendering_blocks[block]);
