...
namespace ITMLib {
	...
	public:
		...
		void RenderImage(const ORUtils::SE3Pose *pose, const Intrinsics *intrinsics, RenderState *renderState, UChar4Image *outputImage, IRaycastingEngine::RenderImageType type) const;
	};
	...
	{
	private:
		RaycastingBlock *renderingBlockList_device;
