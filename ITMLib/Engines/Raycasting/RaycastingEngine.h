...
//  ================================================================
#pragma once
#include "Interface/RaycastingEngineInterface.h"
...
class RaycastingEngine : public RaycastingEngineBase<TVoxel, TIndex> {
private: // instance variables
	internal::RaycastingEngine_Specialized<TVoxel, TIndex, TMemoryDeviceType> specialized_engine;
public: // instance functions
	...
	void RenderImage(VoxelVolume<TVoxel, TIndex>* volume, const ORUtils::SE3Pose* camera_pose, const Intrinsics* intrinsics,
	                 ...
	                 IRaycastingEngine::RenderImageType render_image_type, IRaycastingEngine::RenderRaycastSelection raycast_source) const override;
