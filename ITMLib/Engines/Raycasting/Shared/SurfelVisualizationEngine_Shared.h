 ...
 */
_CPU_AND_GPU_CODE_
inline Vector3f visualization_transform_point(const Matrix4f& T, const Vector3f& p) {
...
_CPU_AND_GPU_CODE_
inline void
copy_correspondences_to_buffers(int surfelId, const TSurfel* surfels, float* newPositions, float* oldPositions,
...
template<typename TSurfel>
_CPU_AND_GPU_CODE_
inline void copy_surfel_data_to_icp_maps(int locId, const TSurfel* surfels, const unsigned int* surfelIndexImage,
                                         const Matrix4f& invT,
                                         float trackingSurfelMaxDepth, float trackingSurfelMinConfidence,
...
template<typename TSurfel>
_CPU_AND_GPU_CODE_
inline void copy_surfel_to_buffers(int surfelId, const TSurfel* surfels, float* positions, unsigned char* normals,
...
_CPU_AND_GPU_CODE_
void
shade_pixel_colour(int locId, const unsigned int* surfelIndexImage, const TSurfel* surfels, Vector4u* outputImage) {
...
template<typename TSurfel>
_CPU_AND_GPU_CODE_
void shade_pixel_confidence(int locId, const unsigned int* surfelIndexImage, const TSurfel* surfels,
                            float stableSurfelConfidence, Vector4u* outputImage) {
...
template<typename TSurfel>
_CPU_AND_GPU_CODE_
void shade_pixel_depth(int locId, const unsigned int* surfelIndexImage, const TSurfel* surfels,
...
template<typename TSurfel>
_CPU_AND_GPU_CODE_
void shade_pixel_grey(int locId, const unsigned int* surfelIndexImage, const TSurfel* surfels, const Vector3f& lightPos,
...
_CPU_AND_GPU_CODE_
void
shade_pixel_normal(int locId, const unsigned int* surfelIndexImage, const TSurfel* surfels, Vector4u* outputImage) {
	Vector4u value((uchar) 0);
...
inline void update_depth_buffer_for_surfel(int surfelId, const TSurfel* surfels, const Matrix4f& invT,
	...
	int locId, scaledZ;
	float z;
	if (project_surfel_to_index_image(surfel, invT, intrinsics, indexImageWidth, indexImageHeight, scaleFactor, locId,
	                                  z, scaledZ)) {
