...
#include "RaycastingEngine_Shared.h"
...
private: // instance variables
	...
	RaycastingBlock* rendering_blocks;

public: // instance functions
	ProjectAndSplitBlocksFunctor(
			ORUtils::MemoryBlock<RaycastingBlock>& rendering_blocks,
			const Matrix4f& depth_camera_pose,
			const Vector4f& depth_camera_projection_parameters,
			const Vector2i& depth_image_size,
			const float voxel_size)
...
public: // instance functions
	...
	_DEVICE_WHEN_AVAILABLE_
	inline void operator()(const RaycastingBlock& block, const int x, const int y) {
...
template<typename TVoxel, typename TIndex, MemoryDeviceType TMemoryDeviceType, IRaycastingEngine::RenderImageType TRenderImageType>
...
template<typename TVoxel, typename TIndex, MemoryDeviceType TMemoryDeviceType>
struct RenderFromVolumeFunctor<TVoxel, TIndex, TMemoryDeviceType, IRaycastingEngine::RENDER_SHADED_GREYSCALE>
...
template<typename TVoxel, typename TIndex, MemoryDeviceType TMemoryDeviceType>
struct RenderFromVolumeFunctor<TVoxel, TIndex, TMemoryDeviceType, IRaycastingEngine::RENDER_COLOUR_FROM_VOLUME>
		: public RenderFromVolumeFunctor_Base<TVoxel, TIndex, TMemoryDeviceType> {
	using RenderFromVolumeFunctor_Base<TVoxel, TIndex, TMemoryDeviceType>::RenderFromVolumeFunctor_Base;
	_DEVICE_WHEN_AVAILABLE_
	inline void operator()(const int pixel_index, const int x, const int y) {
...
template<typename TVoxel, typename TIndex, MemoryDeviceType TMemoryDeviceType>
struct RenderFromVolumeFunctor<TVoxel, TIndex, TMemoryDeviceType, IRaycastingEngine::RENDER_COLOUR_FROM_NORMAL>
		: public RenderFromVolumeFunctor_Base<TVoxel, TIndex, TMemoryDeviceType> {
	using RenderFromVolumeFunctor_Base<TVoxel, TIndex, TMemoryDeviceType>::RenderFromVolumeFunctor_Base;
	_DEVICE_WHEN_AVAILABLE_
	inline void operator()(const int pixel_index, const int x, const int y) {
...
template<typename TVoxel, typename TIndex, MemoryDeviceType TMemoryDeviceType>
struct RenderFromVolumeFunctor<TVoxel, TIndex, TMemoryDeviceType, IRaycastingEngine::RENDER_COLOUR_FROM_CONFIDENCE>
		: public RenderFromVolumeFunctor_Base<TVoxel, TIndex, TMemoryDeviceType> {
	using RenderFromVolumeFunctor_Base<TVoxel, TIndex, TMemoryDeviceType>::RenderFromVolumeFunctor_Base;
	_DEVICE_WHEN_AVAILABLE_
	inline void operator()(const int pixel_index, const int x, const int y) {
...
template<MemoryDeviceType TMemoryDeviceType, bool TFlipNormals, IRaycastingEngine::RenderImageType TRenderImageType>
...
template<MemoryDeviceType TMemoryDeviceType, bool TFlipNormals>
struct RenderFromRaycastFunctor<TMemoryDeviceType, TFlipNormals, IRaycastingEngine::RENDER_SHADED_GREYSCALE_IMAGENORMALS>
