...
#include "../../Utils/SurfelVolumeParameters.h"
...
namespace ITMLib
{
  ...
  private:
    ...
    const SurfelVolumeParameters *m_params;
  ...
  public:
    ...
    {
      if(m_surfelCount + newSurfelCount > m_surfelsMB->element_count) return NULL;
     ...
     */
    const SurfelVolumeParameters& GetParams() const
    {
      return *m_params;
    }
