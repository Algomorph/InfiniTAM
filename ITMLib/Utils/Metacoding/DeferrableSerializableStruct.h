...
#define DECLARE_DEFERRABLE__SERIALIZABLE_STRUCT(...) ITM_METACODING_OUTER_EXPAND(DEFERRABLE_SERIALIZABLE_STRUCT_DECL_IMPL( __VA_ARGS__ )); MACRO_END()
#define DEFINE_DEFERRABLE__SERIALIZABLE_STRUCT(...) ITM_METACODING_OUTER_EXPAND(DEFERRABLE_SERIALIZABLE_STRUCT_DEFN_IMPL( , __VA_ARGS__ )) MACRO_END()
#else
