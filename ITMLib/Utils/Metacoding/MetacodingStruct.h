...
#define GENERATE_SERIALIZABLE_STRUCT(...) ITM_METACODING_OUTER_EXPAND(SERIALIZABLE_STRUCT_IMPL( __VA_ARGS__ ))
#define GENERATE_PATHLESS_SERIALIZABLE_STRUCT(...) ITM_METACODING_OUTER_EXPAND(PATHLESS_SERIALIZABLE_STRUCT_IMPL(__VA_ARGS__))
#define DECLARE_SERIALIZABLE_STRUCT(...) ITM_METACODING_OUTER_EXPAND(SERIALIZABLE_STRUCT_DECL_IMPL( __VA_ARGS__ ))
#define DEFINE_SERIALIZABLE_STRUCT(...) ITM_METACODING_OUTER_EXPAND(SERIALIZABLE_STRUCT_DEFN_IMPL( , __VA_ARGS__ ))
#define DEFINE_INNER_SERIALIZABLE_STRUCT(...) ITM_METACODING_OUTER_EXPAND(SERIALIZABLE_STRUCT_DEFN_IMPL( __VA_ARGS__ ))
#else
