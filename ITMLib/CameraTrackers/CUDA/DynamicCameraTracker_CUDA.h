...
namespace ITMLib{
class DynamicCameraTracker_CUDA : public DynamicCameraTracker, public ExtendedTracker_CUDA {
public:
	DynamicCameraTracker_CUDA(const Vector2i& imgSize_d, const Vector2i& imgSize_rgb, bool useDepth, bool useColour,
	                          ...
	                          int framesToWeight, const LowLevelEngine* lowLevelEngine);
