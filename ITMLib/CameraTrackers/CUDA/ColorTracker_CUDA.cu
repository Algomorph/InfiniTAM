...
ColorTracker_CUDA::ColorTracker_CUDA(Vector2i imgSize, TrackerIterationType *trackingRegime, int noHierarchyLevels, const PreprocessingEngineInterface *lowLevelEngine)
