...
configuration::Configuration GenerateChangedUpConfiguration(){
	...
	configuration::Configuration changed_up_configuration(
			...
			Paths(GENERATED_TEST_DATA_PREFIX "TestData/output",
			      GENERATED_TEST_DATA_PREFIX "TestData/calibration/snoopy_calib.txt",
			      "", "", "",
			      GENERATED_TEST_DATA_PREFIX "TestData/frames/frame_color_%%06i.png",
			      GENERATED_TEST_DATA_PREFIX "TestData/frames/frame_depth_%%06i.png",
			      GENERATED_TEST_DATA_PREFIX "TestData/frames/frame_mask_%%06i.png",
			      ""),
