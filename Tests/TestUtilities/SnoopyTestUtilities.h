...
std::string PartialVolume00Path() {
	return GENERATED_TEST_DATA_PREFIX "TestData/volumes/" + test_utilities::IndexString<TIndex>() + "/snoopy_partial_frame_00.dat";
}
...
std::string PartialVolume16Path() {
	return GENERATED_TEST_DATA_PREFIX "TestData/volumes/" + test_utilities::IndexString<TIndex>() + "/snoopy_partial_frame_16.dat";
}
...
std::string PartialVolume17Path() {
	return GENERATED_TEST_DATA_PREFIX "TestData/volumes/" + test_utilities::IndexString<TIndex>() + "/snoopy_partial_frame_17.dat";
}
...
std::string FullVolume16Path() {
	return GENERATED_TEST_DATA_PREFIX "TestData/volumes/" + test_utilities::IndexString<TIndex>() + "/snoopy_full_frame_16.dat";
}
...
std::string FullVolume17Path() {
	return GENERATED_TEST_DATA_PREFIX "TestData/volumes/" + test_utilities::IndexString<TIndex>() + "/snoopy_full_frame_17.dat";
}
