...
std::string PartialVolume16Path() {
	return test_utilities::GeneratedVolumeDirectory + test_utilities::IndexString<TIndex>() + "/snoopy_partial_frame_16.dat";
}
...
std::string PartialVolume17Path() {
	return test_utilities::GeneratedVolumeDirectory + test_utilities::IndexString<TIndex>() + "/snoopy_partial_frame_17.dat";
}
...
std::string FullVolume16Path() {
	return test_utilities::GeneratedVolumeDirectory + test_utilities::IndexString<TIndex>() + "/snoopy_full_frame_16.dat";
}
...
std::string FullVolume17Path() {
	return test_utilities::GeneratedVolumeDirectory + test_utilities::IndexString<TIndex>() + "/snoopy_full_frame_17.dat";
}
