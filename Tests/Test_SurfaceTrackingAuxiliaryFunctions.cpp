...
BOOST_FIXTURE_TEST_CASE(Test_ClearOutFramewiseWarp_CPU_PVA, Frame16And17Fixture){
	...
	BOOST_REQUIRE_CLOSE(StatCalc_CPU_PVA_Warp::Instance().ComputeFramewiseWarpMax(warps_PVA), 0.18186526000499725f, relativeTolerance);
	BOOST_REQUIRE_CLOSE(StatCalc_CPU_PVA_Warp::Instance().ComputeFramewiseWarpMin(warps_PVA), 0.0f, relativeTolerance);
	...
	BOOST_REQUIRE_CLOSE(StatCalc_CPU_PVA_Warp::Instance().ComputeFramewiseWarpMax(warps_PVA), 0.0f, relativeTolerance);
	BOOST_REQUIRE_CLOSE(StatCalc_CPU_PVA_Warp::Instance().ComputeFramewiseWarpMin(warps_PVA), 0.0f, relativeTolerance);
...
BOOST_FIXTURE_TEST_CASE(Test_ClearOutFramewiseWarp_CPU_VBH, Frame16And17Fixture){
	...
	float relativeTolerance = 0.1f;//percent
	BOOST_REQUIRE_CLOSE(StatCalc_CPU_VBH_Warp::Instance().ComputeFramewiseWarpMax(warps_VBH), 0.18186526000499725f, relativeTolerance);
	BOOST_REQUIRE_CLOSE(StatCalc_CPU_VBH_Warp::Instance().ComputeFramewiseWarpMin(warps_VBH), 0.0f, relativeTolerance);
	...
	BOOST_REQUIRE_CLOSE(StatCalc_CPU_VBH_Warp::Instance().ComputeFramewiseWarpMax(warps_VBH), 0.0f, relativeTolerance);
	BOOST_REQUIRE_CLOSE(StatCalc_CPU_VBH_Warp::Instance().ComputeFramewiseWarpMin(warps_VBH), 0.0f, relativeTolerance);
...
BOOST_FIXTURE_TEST_CASE(Test_ClearOutFramewiseWarp_CUDA_PVA, Frame16And17Fixture){
	...
	float relativeTolerance = 0.1f;//percent
	BOOST_REQUIRE_CLOSE(StatCalc_CUDA_PVA_Warp::Instance().ComputeFramewiseWarpMax(warps_PVA), 0.18186526000499725f, relativeTolerance);
	BOOST_REQUIRE_CLOSE(StatCalc_CUDA_PVA_Warp::Instance().ComputeFramewiseWarpMin(warps_PVA), 0.0f, relativeTolerance);
	...
	BOOST_REQUIRE_CLOSE(StatCalc_CUDA_PVA_Warp::Instance().ComputeFramewiseWarpMax(warps_PVA), 0.0f, relativeTolerance);
	BOOST_REQUIRE_CLOSE(StatCalc_CUDA_PVA_Warp::Instance().ComputeFramewiseWarpMin(warps_PVA), 0.0f, relativeTolerance);
...
BOOST_FIXTURE_TEST_CASE(Test_ClearOutFramewiseWarp_CUDA_VBH, Frame16And17Fixture){
	...
	float relativeTolerance = 0.1f;//percent
	BOOST_REQUIRE_CLOSE(StatCalc_CUDA_VBH_Warp::Instance().ComputeFramewiseWarpMax(warps_VBH), 0.18186526000499725f, relativeTolerance);
	BOOST_REQUIRE_CLOSE(StatCalc_CUDA_VBH_Warp::Instance().ComputeFramewiseWarpMin(warps_VBH), 0.0f, relativeTolerance);
	...
	BOOST_REQUIRE_CLOSE(StatCalc_CUDA_VBH_Warp::Instance().ComputeFramewiseWarpMax(warps_VBH), 0.0f, relativeTolerance);
	BOOST_REQUIRE_CLOSE(StatCalc_CUDA_VBH_Warp::Instance().ComputeFramewiseWarpMin(warps_VBH), 0.0f, relativeTolerance);
